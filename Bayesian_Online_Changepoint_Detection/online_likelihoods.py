...
class StudentT(BaseLikelihood):
    ...
    def update_theta(self, data: np.array, **kwargs):
        ...
        Parmeters:
            ...
            The parameters are being updated using
...
class Poisson:
    ...
    '''The negative binomial distribution was originally derived as a limiting case of the gamma-Poisson distribution
    ...
    Parameters:
        ...
        Co'''
    def pdf(self, data):
        return ss.nbinom.pmf(data,self.k, 1/(1+self.theta))
